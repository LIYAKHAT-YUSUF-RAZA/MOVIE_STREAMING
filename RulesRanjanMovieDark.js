...
/* import RulesRanjanMovieDVD from "/RulesRanjanMovieDVD.mkv"; */
...
function RulesRanjanMovie(){
 ...
 const [onRulesRanjanMovieDVD, setRulesRanjanMovieDVD] = useState('');
   const [onRulesRanjanMovieLight, setRulesRanjanMovieLight] = useState();
  /* Movie online watch */
  if(onRulesRanjanMovieDVD){
    return <Navigate to="/RulesRanjanMovieWatch"></Navigate>
  }

if(onRulesRanjanMovieLight){
...
if(onSearchBar){
  return <Navigate to="/SearchBar"></Navigate>
    ...
    return(
    <div className="Dark">
      {/* <ReactPlayer url={"https://youtu.be/iU2rMRZcn1U?si=H6jhNg56WCk1aXw1"} controls style={{height:"500px"}} /> */}
        <div className="r">
    ...
    <div>
      ...
      <div>
        ...
        <div className="container">
            ...
            <div>
               <h1 style={{ color: "white" }}><u> _______?_______ </u></h1><br/><br/>
                <p className="A"><b className="Y">MOVIE-NAME :--{">"}</b>  RULES RANJAN  </p>
                <p className="A"><b className="Y">KIRAN ABBAVARAM CHARACTOR :-</b>  HERO  </p>
                <p className="A"><b className="Y">HERONIE-NAME</b>   Neha Shetty</p>
                <p className="A"><b className="Y">DIRECTED-BY :--{">"}</b>  		Rathinam Krishna</p>
                <p className="A"><b className="Y">PRODUCED-BY :--{">"}</b>  	Divyang Lavania , Murali Krishnaa Vemuri </p>
                <p className="A"><b className="Y">CINEMATOGRAPHY :--{">"}</b> 		Dulip Kumar M. S.</p>
                <p className="A"><b className="Y"> WRITTEN BY  :--{">"}</b> 	Rathinam Krishna</p>
                <p className="A"><b className="Y">CAST :--{">"}</b> Kiran Abbavaram,Neha Shetty,Vennela Kishore,Subbaraju,Hyper Aadhi,Harsha Chemudu
                ,Ajay,Nagineedu,Makarand Deshpande,Abhimanyu Singh and others</p>
                <p className="A"><b className="Y">BUDGET :--{">"}</b>  	8.00 Crore Rs</p>
            ...
            <center>
            {/* <a href="./RulesRanjanMovieDVD.mp4" alt="Movie Not Found" className="a1"><button className="but"> <b> WATCH MOVIE </b></button></a> */}
            <a className="a1">
            <button onClick={() => { setRulesRanjanMovieDVD(true); } } className="but" ><b>Watch Movie Online</b></button></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br/><br/>
            <a className="a1"/*  href={RulesRanjanMovieDVD} download="RulesRanjanMovieDVD"  target="_blank" rel="noreferrer"*/ >
        ...
        <br/><br/>
        <div className="s000">
        <h2 className="h10">RULES RANJAN MOVIE SONGS</h2><br/>
        ...
        <p>1)&nbsp; Naalo Nenu Lenu song (AUDIO + VIDEO)<a href="https://youtu.be/iU2rMRZcn1U?si=H6jhNg56WCk1aXw1" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>2)&nbsp; Sammohanuda song (AUDIO +LYRICAL VIDEO)<a href="https://youtu.be/aJQcn34K_S8?si=TAcKZpHX6c6GzpIw" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>3)&nbsp; Enduku Ra Babu song (AUDIO + LYRICAL VIDEO)<a href="https://youtu.be/mek3NUdudG8?si=GSLro7V3p9VeIq6x" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>4)&nbsp;  Dhekho Mumbai song (AUDIO + LYRICAL VIDEO)<a href="https://youtu.be/-R3LZx2fidU?si=1sAYgvsevPVjHH6n" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        </div>
        {/* CLOSING SONGS */}
