...
if(onRulesRanjan){
  return <Navigate to="/RulesRanjanMovieLight"></Navigate>
}
  ...
  return <Navigate to="/LatestMoviesTelDark"></Navigate>
    ...
    <div className="r">
     ...
     <input type="text"  value={Search}
      ...
      />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <button style={{border:"0px",borderRadius:"50%",height:"25px",width:"25px"}}  onClick={() => { setLatestMoviesTelDark(true); } } title="Active Dark Mode">
...
{/* <button><a href="/SearchBar">Search</a*/}
      ...
      {isCollapsed ? null : (
        ...
        <div>
            <button className="s"><a href="./LatestMoviesTelLight" className="a2"><b>LATEST MOVIES TELUGU </b></a></button>
          </div>
          <div>
    ...
    <div>
        ...
        <div>
            <button className="b--000-L"  onClick={() => { setRulesRanjan(true); } }>
            <h2 className="h--000-L"><img src={"https://m.media-amazon.com/images/M/MV5BNGYzMTk0YzAtOTcyNy00M2U4LTk5ZmEtZTU4ODkyNWNmNjVmXkEyXkFqcGdeQXVyMTYwNjM4Mzcy._V1_.jpg"} alt="not found" className="i--000" title="Rules Ranjan"></img>Rules Ranjan
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>06-10-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://timesofindia.indiatimes.com/photo/103920940.cms"} alt="not found" className="i--000" title="God"></img>God
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>06-10-2023</p></h2></button>
            <button className="b--000-L">
            <b className="h--000-L" style={{fontSize:"17px",paddingTop:"5px"}}><img src={"https://m.media-amazon.com/images/M/MV5BZTgyODhlMGYtYzg1My00NTA2LTgxYmEtZDFjNmEzNTM5N2MxXkEyXkFqcGdeQXVyMTU0ODI1NTA2._V1_FMjpg_UX1000_.jpg"} alt="not found" className="i--000" title="Mama Mascheendra"></img>Mama Mascheendra
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>06-10-2023</p></b></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://static.toiimg.com/thumb/103442018.cms?width=170&height=240&imgsize=50983"} alt="not found" className="i--000" title="Mad"></img>Mad
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>06-10-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://timesofindia.indiatimes.com/photo/104191525.cms"} alt="not found" className="i--000" title="GTA (Guns Trance Action)"></img> GTA
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>06-10-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/month-of-madhu-et00371104-1695904210.jpg"} alt="not found" className="i--000" title="Month Of Madhu"></img>Month of Madhu
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>06-10-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://assets.eenadu.net/article_img/0510Chinna1.jpg"} alt="not found" className="i--000" title="Chinna"></img>Chinna
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>06-10-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://timesofindia.indiatimes.com/photo/100759702.cms"} alt="not found" className="i--000" title="Pedda Kaapu"></img>Pedda Kaapu-1
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>29-09-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://m.media-amazon.com/images/M/MV5BOTZkMGU2NjktNWZlMi00YzliLWI1NmQtZjc4MTdkNzQyODAzXkEyXkFqcGdeQXVyMTUzNTgzNzM0._V1_.jpg"} alt="not found" className="i--000" title="Skanda"></img>Skanda
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>28-09-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://upload.wikimedia.org/wikipedia/en/d/de/Chandramukhi_2_poster.jpg"} alt="not found" className="i--000" title="Chandramukhi 2"></img>Chandramukhi 2
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>28-09-2023</p></h2></button>
            <button className="b--000-L">
            <b className="h--000-L" style={{fontSize:"15px",paddingTop:"5px"}}><img src={"https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/sapta-sagaralu-dhaati--side-a-et00370097-1695193371.jpg"} alt="not found" className="i--000" title="Sapta Sagaralu Dhaati - Side A Sapta Sagaralu Dhaati"></img>Sapta Sagaralu Dhaati 
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>22-09-2023</p></b></button>
            <button className="b--000-L">
            <h2 className="h--000-L" style={{fontSize:"17px",paddingTop:"5px"}}><img src={"https://m.media-amazon.com/images/M/MV5BYTM4Y2YzNTAtNDg2Yy00YWZhLWI3MDYtMWM3YTdmMmI1OGNkXkEyXkFqcGdeQXVyNjUxNzk5NzU@._V1_FMjpg_UX1000_.jpg"} alt="not found" className="i--000" title="Ashtadigbandhanam"></img>Ashtadigbandhanam
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>22-09-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/cheater-2023-et00369289-1694413100.jpg"} alt="not found" className="i--000" title="Cheater"></img>Cheater
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>22-09-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://assets.gadgets360cdn.com/pricee/assets/product/202309/Rudramkota_1695104790.jpg"} alt="not found" className="i--000" title="Rudramkota"></img>Rudramkota
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>22-09-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://upload.wikimedia.org/wikipedia/en/3/39/Jawan_film_poster.jpg"} alt="not found" className="i--000" title="Jawan"></img>Jawan
            <br/><p style={{fontSize:"15px",paddingTop:"5px"}}>07-09-2023</p></h2></button>
            <button className="b--000-L">
            <b className="h--000-L"  style={{fontSize:"14px",paddingTop:"5px"}}><img src={"https://m.media-amazon.com/images/M/MV5BNWE5NGZkOWYtODlkZS00Mzk5LWIzZjgtMjk4NzAxNzFmODA3XkEyXkFqcGdeQXVyMTQ3Mzk2MDg4._V1_.jpg"} alt="not found" className="i--000" title="Miss Shetty Mr Polishetty"></img>
            Miss Shetty Mr Polishetty<br/><h2><p style={{fontSize:"15px"}}>07-09-2023</p></h2></b></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://cdn.123telugu.com/content/wp-content/uploads/2023/09/Kushi-m.jpg"} alt="not found" className="i--000" title="Kushi"></img>
            Kushi<br/><p style={{fontSize:"15px",paddingTop:"5px"}}>01-09-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://upload.wikimedia.org/wikipedia/en/b/be/RDX-_Robert_Dony_Xavier_poster.jpg"} alt="not found" className="i--000" title="RDX: Robert Dony Xavier"></img>
            RDX<br/><p style={{fontSize:"15px",paddingTop:"5px"}}>25-08-2023</p></h2></button>
            <button className="b--000-L">
            <b className="h--000-L" style={{fontSize:"15px"}}><img src={"https://m.media-amazon.com/images/M/MV5BMmVkNTdjZmMtMWNmMC00ZjY1LThmYTQtODRiMGU2ZTFkYjgzXkEyXkFqcGdeQXVyMTQ3Mzk2MDg4._V1_FMjpg_UX1000_.jpg"} alt="not found" className="i--000" title="Gandeevadhari arjuna"></img>
            Gandeevadhari arjuna<br/><h2><p style={{fontSize:"15px",paddingTop:"5px"}}>25-08-2023</p></h2></b></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://www.cinejosh.com/reviewsimg/big/bedurulanka-2012-review_b_2508231227.jpg"} alt="not found" className="i--000" title="Bedurulanka 2012"></img>
            Bedurulanka<br/><p style={{fontSize:"15px",paddingTop:"5px"}}>25-08-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://cdn.123telugu.com/content/wp-content/uploads/2023/08/KingOfKotha-m-1.jpg"} alt="not found" className="i--000" title="King of kotha"></img>
            King of kotha<br/><p style={{fontSize:"15px",paddingTop:"5px"}}>24-08-2023</p></h2> </button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://m.media-amazon.com/images/M/MV5BOTU4NmI5MTktYzBlYS00ZmRiLWFmYjYtMjA5ZWYwZWM2ZTQ0XkEyXkFqcGdeQXVyMTU4MzQ3ODk1._V1_.jpg"} alt="not found" className="i--000" title="Bhola Shankar"></img>
            Bhola Shanker<br/><p style={{fontSize:"15px",paddingTop:"5px"}}>11-08-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://timesofindia.indiatimes.com/photo/92282228.cms"} alt="not found" className="i--000" title="Jailer"></img>
            Jailer<br/><p style={{fontSize:"15px",paddingTop:"5px"}}>10-08-2023</p></h2></button>
            <button className="b--000-L">
            <h2 className="h--000-L"><img src={"https://assets.eenadu.net/article_img/2007Hidimba001.jpg"} alt="not found" className="i--000" title="Hidimba"></img>
...
export default LatestMoviesTelLight;