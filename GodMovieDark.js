...
function GodMovieDark(){
  ...
  const [onGodMovieLight, setGodMovieLight] = useState();
if(onGodMovieLight){
  return <Navigate to="/GodMovieLight"></Navigate>
}
if(onSearchBar){
  return <Navigate to="/SearchBar"></Navigate>
    ...
    <div className="Dark">
      ...
      <button style={{border:"0px",borderRadius:"50%",backgroundColor:"black",height:"25px",width:"25px"}}  onClick={() => { setGodMovieLight(true); } } title="Active Light Mode">
    ...
    <div>
      ...
      <div>
        ...
        <div className="container">
            ...
            <div>
               <h1 style={{ color: "white" }}><u> __AVERAGE__ </u></h1><br/><br/>
                <p className="A"><b className="Y">MOVIE-NAME :--</b>  GOD  </p>
                {/* <p className="A"><b className="Y">KIRAN ABBAVARAM CHARACTOR :-</b>  HERO  </p> */}
                <p className="A"><b className="Y">HERONIE-NAME</b>   Nayanthara</p>
                <p className="A"><b className="Y">DIRECTED-BY :--</b> I.Ahmed 		</p>
                <p className="A"><b className="Y">PRODUCED-BY :--</b>   Arunachalam Vaidyanathan </p>
                <p className="A"><b className="Y">CINEMATOGRAPHY :--</b> Hari	K. Vedantam</p>
                <p className="A"><b className="Y"> WRITTEN BY  :--</b>  I.Ahmed 	</p>
                <p className="A"><b className="Y">MAIN CAST :--</b> Jayam Ravi , Nayanthara , Ashish Vidyarthi</p>
               ...
               {/*  <p className="A"><b className="Y">COLLECTION :--</b> (India)	15.75 Crore Grosses (AP/TS) [Till 25th December, 2017]</p> */}
                <p className="A"><b className="Y">RELEASE-DATE :--</b> 	13 October 2023 </p>
            </div>
       </div>
            <center>
        ...
        <br/><br/>
        <div className="s000">
        <h2 className="h10">GOD MOVIE SONGS</h2><br/>
        <p>All Songs&nbsp;&nbsp;(AUDIO ONLY)<a href="https://www.naasongs.co/a/god-telugu-movie-2023-rgbt1-songs.html" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a></p><br/>
        <p>1)&nbsp; Kalale Kalale song (AUDIO + VIDEO)<a href="https://youtu.be/MSsKm7z8lz8?si=bfdDysgpYL5-8Ez4" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>2)&nbsp;Hey Dhooram song (AUDIO +LYRICAL VIDEO)<a href="https://youtu.be/L-XyTpUmn1I?si=5apKNEpIehYCuZHg" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>3)&nbsp;Sahodharaa song (AUDIO + LYRICAL VIDEO)<a href="#" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>4)&nbsp;Preminche Manasune song (AUDIO + LYRICAL VIDEO)<a href="https://youtu.be/15ZgaZdfNmk?si=pcreQV-bTAhwbqVQ" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        </div>
        {/* CLOSING SONGS */}
