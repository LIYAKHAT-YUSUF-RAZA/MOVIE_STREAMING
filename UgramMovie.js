...
{/* <button><a href="/SearchBar">Search</a*/}
    ...
    <div className="container">
            <img src={"https://assets-in.bmscdn.com/discovery-catalog/events/et00072884-zwgnkaxger-landscape.jpg"} alt="not found" />&nbsp;
            <div>
               <h1 style={{ color: "white" }}><u> ___SUCCESSFUL___ </u></h1>
                <p className="A"><b className="Y">MOVIE-NAME :--{">"}</b>  UGRAM </p>
                <p className="A"><b className="Y">HERONIE-NAME</b>  Mirna Menon</p>
                <p className="A"><b className="Y">DIRECTED-BY :--{">"}</b>  Vijay Kanakamedala</p>
                <p className="A"><b className="Y">PRODUCED-BY :--{">"}</b>  Sahu Garapati , Harish Peddi </p>
                <p className="A"><b className="Y">SCREENPLAY :--{">"}</b> Vijay Kanakamedala</p>
                <p className="A"><b className="Y">STORY-BY :--{">"}</b> Toom Venkat</p>
                <p className="A"><b className="Y">CAST :--{">"}</b> Allari Naresh, Mirnaa Menon, Indraja, Sharath Lohithaswa, Shatru, Srinivas Sai, Manikanta Varanasi, Naga Mahesh, Ramesh Reddy, Baby Uha Reddy</p>
                <p className="A"><b className="Y">BUDGET :--{">"}</b>  Rs 15 Crores</p>
                <p className="A"><b className="Y">COLLECTION :--{">"}</b>  Rs 5.60 Crores</p>
                <p className="A"><b className="Y">RELEASE-DATE :--{">"}</b>  5 May 2023</p>
            </div>
    </div>
            <center>
            <a href="https://top.ibomma.day/d/Ugram-telugu-2023-MPXf-watch-online.html"
                    alt="Movie Not Found" className="a1"><button className="but"> <b> WATCH MOVIE </b></button></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="https://youtu.be/mLf8EgSThz0?si=_JDAfAOsAyGSQ0vR"
        ...
        <br/><br/>
        <div className="s000">
        <h2 className="h10">UGRAM MOVIE SONGS</h2><br/>
        <p>All Songs&nbsp;&nbsp;(AUDIO ONLY)<a href="https://www.naasongs.co/a/ugram-telugu-m1na-songs.html" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a></p><br/>
        <p>1)&nbsp; Albela Albela song (AUDIO + VIDEO)<a href="https://youtu.be/Kzh6EJzQPTo?si=iyX_AGPaYPGjbJVn" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>2)&nbsp;Deveri song (AUDIO + VIDEO)<a href="https://youtu.be/4gY1RK8Gs1k?si=iuHM_9WiSVlJKtes" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>3)&nbsp;Ugram Ugram song (AUDIO +LYRICAL VIDEO)<a href="https://youtu.be/ZuloyUZ_6rQ?si=TzV10VgGf52tkcgm" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        {/* CLOSING SONGS */}
        {/*CLOSING UGRAM */}
