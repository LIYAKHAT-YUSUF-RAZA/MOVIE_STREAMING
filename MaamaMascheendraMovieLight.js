...
function MaamaMascheendraMovieLight(){
  ...
  const [onMaamaMascheendraMovieDark, setMaamaMascheendraMovieDark] = useState();
if(onMaamaMascheendraMovieDark){
...
if(onSearchBar){
  return <Navigate to="/SearchBar"></Navigate>
    ...
    <div className="Light">
      ...
      <button style={{border:"0px",borderRadius:"50%",height:"25px",width:"25px"}}  onClick={() => { setMaamaMascheendraMovieDark(true); } } title="Active Dark Mode">
    ...
    <div>
      ...
      <div>
        ...
        <div className="container-L">
            <img src={"https://upload.wikimedia.org/wikipedia/en/thumb/8/81/MaamaMascheendra.jpg/220px-MaamaMascheendra.jpg"} alt="not found" />&nbsp;
            <div>
               <h1 style={{ color: "Black" }}><u> ____AVERAGE____ </u></h1><br/><br/>
                <p className="A-L"><b className="Y-L">MOVIE-NAME :--{">"}</b>  MAAMA MASCHEENDRA  </p>
               {/*  <p className="A-L"><b className="Y-L">KIRAN ABBAVARAM CHARACTOR :-</b>  HERO  </p> */}
                <p className="A-L"><b className="Y-L">HERONIE-NAME</b>   Eesha Rebba</p>
                <p className="A-L"><b className="Y-L">DIRECTED-BY :--{">"}</b>  	Harsha Vardhan</p>
                <p className="A-L"><b className="Y-L">PRODUCED-BY :--{">"}</b>  Sunil Narang , Puskur Ram Mohan Rao </p>
                <p className="A-L"><b className="Y-L">CINEMATOGRAPHY :--{">"}</b> 	P. G. Vinda</p>
                <p className="A-L"><b className="Y-L"> WRITTEN BY  :--{">"}</b> 	Harsha Vardhan</p>
                <p className="A-L"><b className="Y-L">CAST :--{">"}</b> Sudheer Babu , Eesha Rebba , Mirnalini Ravi,
                Harsha Vardhan, Rajiv Kanakala ,Mirchi Kiran , Ajay and others</p>
                <p className="A-L"><b className="Y-L">BUDGET :--{">"}</b>  	15.00 Crore Rs</p>
        ...
        <br/><br/>
        <div className="s000">
        <h2 className="h10-L">MAAMA MASCHEENDRA MOVIE SONGS</h2><br/>
        ...
        <p> MAAMA MASCHEENDRA MOVIE songs (AUDIO + LYRICAL VIDEO)<a href="https://youtu.be/YZO4aLxhXbI?si=dvl8ShysCvb6qbLS" alt="not found" className="a0-L">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>1)&nbsp; Gaalullona song (AUDIO + VIDEO)<a href="https://youtu.be/kA4soDbxx_o?si=0hb5KaUbIXrB2CuK" alt="not found" className="a0-L">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>2)&nbsp; Adiga Adiga song (AUDIO + VIDEO)<a href="https://youtu.be/dLPdm5Bw1Zg?si=Hml3lP0B_cI1J7Du" alt="not found" className="a0-L">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>3)&nbsp; Mandhu song (AUDIO + LYRICAL VIDEO)<a href="https://youtu.be/1n-rsKfXyWU?si=R4IkXoPFyifWtN8z" alt="not found" className="a0-L">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>4)&nbsp; Cheli Cheli Kalavarame song (AUDIO + LYRICAL VIDEO)<a href="#" alt="not found" className="a0-L">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        </div>
        {/* CLOSING SONGS */}
...
export default MaamaMascheendraMovieLight;