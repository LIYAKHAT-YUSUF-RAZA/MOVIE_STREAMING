...
{/* <button><a href="/SearchBar">Search</a*/}
    ...
    <div>
      ...
      <button className="s"><a href="./TelActorsLight"><b>Light Mode</b></a></button>
        ...
        {/* STARTING AKHIL MOVIE */}
        <div className="container">
        <img src={"https://m.media-amazon.com/images/M/MV5BZTNkYzAyODEtZjQ5Yy00NjhiLTgyY2MtYzIzNzJhZjYwY2EwL2ltYWdlXkEyXkFqcGdeQXVyMjY1MjkzMjE@._V1_.jpg"} alt="not found" />&nbsp;
        <div>
        <h1 style={{ color: "white" }}><u> _____DISASTER_____ </u></h1>
        <p className="A"><b className="Y">MOVIE-NAME :--{">"}</b>  AKHIL </p>
        <p className="A"><b className="Y">Starring :- </b> Akhil Akkineni , Sayyeshaa</p>
        <p className="A"><b className="Y">Directed by :- </b>  V. V. Vinayak</p>
        <p className="A"><b className="Y">Screenplay by :- </b>  V. V. Vinayak</p>
        <p className="A"><b className="Y">Story by :- </b> Veligonda Srinivas </p>
        <p className="A"><b className="Y">Produced by :- 	</b>Nithiin , Sudhakar Reddy</p>
        <p className="A"><b className="Y">Cinematography :- </b> Amol Rathod </p>
        <p className="A"><b className="Y">Edited by :- </b> 	Gautham Raju </p>
        <p className="A"><b className="Y">Music by :- </b>  Anup Rubens</p>
        <p className="A"><b className="Y">Production company :- 	</b>  Sreshth Movies</p>
        <p className="A"><b className="Y">Release date :- </b>  11 November 2015</p>
        <p className="A"><b className="Y">Running time :- </b> 130 minutes </p>
        <p className="A"><b className="Y">Country :- </b> India </p>
        <p className="A"><b className="Y">Language :- </b> Telugu </p>
        <p className="A"><b className="Y">Budget :- </b>₹50 crore  </p>
        <p className="A"><b className="Y">Box office :- </b> est. ₹33.65 crore </p>
        </div></div>
        <center>
            <a href=""
            alt="Movie Not Found" className="a1"><button className="but" disabled> <b> WATCH MOVIE </b></button></a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="https://youtu.be/jXXz-Jo9cu8?si=tZlUnRHbIXafNpvh"
        ...
        <br/><br/>
    <div className="s000">
        <h2 className="h10">AKHIL MOVIE SONGS</h2><br/>
        <p>All Songs&nbsp;&nbsp;(AUDIO ONLY)<a href="https://www.jiosaavn.com/album/akhil-the-power-of-jua/QMv6NgFS3Gw_" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a></p><br/>
        <p>1)&nbsp;Nennekkadunte (Energy)  song (AUDIO + VIDEO)<a href="https://youtu.be/cmNMmfJdWb4?si=vC0TWzOMFGH7OjaO" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a /* href={RamaKrishna} download="RamaKrishna" target="_blank" rel="noreferrer" */>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>2)&nbsp;Hey Akhil song (AUDIO + VIDEO)<a href="https://youtu.be/P-_9T2ETRyk?si=EIEI1sPumE-QcTkJ" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>3)&nbsp;Zara Zara Navvaradhe song (AUDIO + VIDEO)<a href="https://youtu.be/Yk5407X0Nk8?si=DHu1sE3uEyEBPFDq" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>4)&nbsp;Akkineni Akkineni song (AUDIO + VIDEO)<a href="https://youtu.be/I-qCNDD0Ogk?si=lNAu2kPobHvkBOji" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>5)&nbsp;Padessavae song (AUDIO + VIDEO)<a href="https://youtu.be/4gyRuTV6EB0?si=QiUc34W-oE_ypQ-D" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
    {/* CLOSING SONGS */}
    {/* CLOSING AGENT MOVIE*/}
      ...
      <div className="mc">
        <div class="row">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="./TeluguBlockbuster">Telugu Blockbuster Movies</a><br/><br/>
