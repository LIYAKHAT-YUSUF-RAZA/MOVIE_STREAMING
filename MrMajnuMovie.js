...
<img src={"https://upload.wikimedia.org/wikipedia/en/c/cd/Mr.Majnu.jpg"} alt="not found" />&nbsp;
            <div>
               <h1 style={{ color: "white" }}><u> _____FLOP_____ </u></h1>
                <p className="A"><b className="Y">MOVIE-NAME :--{">"}</b>  MR . MAJNU </p>
                <p className="A"><b className="Y">HERONIE-NAME</b>   Nidhhi Agerwal</p>
                <p className="A"><b className="Y">DIRECTED-BY :--{">"}</b>  Venky Atluri</p>
                <p className="A"><b className="Y">PRODUCED-BY :--{">"}</b>  B.V.S.N. Prasad </p>
                <p className="A"><b className="Y">WRITERS :--{">"}</b> 	Venky Atluri</p>
                <p className="A"><b className="Y"> EDITORS  :--{">"}</b> Navin Nooli</p>
                <p className="A"><b className="Y">CAST :--{">"}</b> Akhil Akkineni, Nidhhi Agerwal, Kailash Reddy, Subbaraju, Rao Ramesh, Jayaprakash,Priyadarshi Pullikonda,
                 Vidyullekha Raman, Izabelle Leite, Naga Babu, Raja Chembolu, Ajay, Pavitra Lokesh, Sithara, Devendhar (introducing), Kadambari Kiran, And Others</p>
                <p className="A"><b className="Y">BUDGET :--{">"}</b>  Approx 25.00 Crore Rs</p>
                <p className="A"><b className="Y">COLLECTION :--{">"}</b> (WorldWide)	21.00 Crore [Life Time]</p>
                <p className="A"><b className="Y">RELEASE-DATE :--{">"}</b>  25 January, 2019</p>
            </div>
       </div>
            <center>
            <a href="https://youtu.be/nCUEQytFAaE?si=OYGl9Ppu0SzJYSy0"
                    alt="Movie Not Found" className="a1"><button className="but"> <b> WATCH MOVIE </b></button></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="https://youtu.be/XSnFa0zqXRM?si=U9XpgTYKYFr5isqo"
        ...
        <br/><br/>
        <div className="s000">
        <h2 className="h10">MR.MAJNU MOVIE SONGS</h2><br/>
        <p>All Songs&nbsp;&nbsp;(AUDIO ONLY)<a href="https://www.naasongs.co/a/mr-majnu-2018-1-songs.html" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a></p><br/>
        <p>1)&nbsp;Yemainado song (AUDIO + VIDEO)<a href="https://youtu.be/t8oOYuFd-zw?si=mzMuTUAiy081BNQk" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>2)&nbsp;Mr.Majnu song (AUDIO + VIDEO)<a href="https://youtu.be/tTpQbfHj4j4?si=q8CmomkOPuHBpPKd" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>3)&nbsp;Naalo Neeku song (AUDIO + VIDEO)<a href="https://youtu.be/iyNMThnyXCI?si=F2Z3nFf76efoZUsO" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>4)&nbsp;Hey Nenila song (AUDIO + VIDEO)<a href="https://youtu.be/JoPZMfF3xsk?si=ZLinQqOmsBxvGvZe" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>5)&nbsp;Koppamga Koppamga song (AUDIO + VIDEO)<a href="https://youtu.be/IW9i3bJ8bkU?si=fBTBictnGNdJpn_q" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        <p>6)&nbsp;Chiru Chiru Navvula song (AUDIO + VIDEO)<a href="https://youtu.be/BDKw1q2QsDg?si=3KURjjf6jJfmna7c" alt="not found" className="a0">&nbsp;&nbsp;&nbsp;<u>Click here</u></a>
        <a  href="#" /* href={RamaKrishna}  download="RamaKrishna" target="_blank" rel="noreferrer"*/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button className="dd">Download Song</button></a></p><br/>
        </div>
        {/* CLOSING SONGS */}
